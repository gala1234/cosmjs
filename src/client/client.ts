...
export const bondMixNode = async (
  ...
  return await client.execute(
    ...
    "n14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9sjyvg3g", // contract address
    msg, //msg
    100000, // fee
    "let's bond a mixnode", // memo
    [{ amount: "100000000", denom: "unym" }] // pledge
  );
};

export const unbondMixnode = async (
  client: SigningCosmWasmClient,
  address: string
): Promise<ExecuteResult> => {
  const msg = {
...
export const getAllDelegationsPaged = async (
  client: SigningCosmWasmClient,
  limit?: number
): Promise<String> => {
  return await client.queryContractSmart(
    "n14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9sjyvg3g",
    { get_all_delegations: { limit } }
  );
};
...
export const delegateToMixNode = async (
  ...
  return await client.execute(
    ...
    msg, //msg
    100000, // fee
    "let's delegate to mixnode", //memo
    [{ amount: "100", denom: "unym" }] //pledge
  );
};
